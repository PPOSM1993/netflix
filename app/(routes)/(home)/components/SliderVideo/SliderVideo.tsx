    ...
    <div className="relative w-full -[80vw] md:h-[56.25vw] lg:h-[45vw]">
      ...
      >
        <div className="pt-24 md:pt-0">
          <h2 className="text-2xl md:text-3xl lg:text-6xl font-bold drop-shadow-xl">
            Clone Netflix
          </h2>
          <p className="max-w-md mt-2 text-xs md:text-base text-justify">
            This is a video trailer for a Netflix clone project, where you can watch movies and TV shows from your favorite streaming services.
          </p>
